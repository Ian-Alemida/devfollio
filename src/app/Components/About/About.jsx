    ...
    return (
        <div className="content-about" id='About'>
            ...
            <div className='content-about-text'>
                ...
                <p className='content-about-text-p'>Olá! Sou um Desenvolvedor Front-end especializado em Next.js, apaixonado por tecnologia e com uma sólida experiência em HTML5, CSS3 e JavaScript. Também estou imerso nos estudos de cibersegurança e sou um entusiasta da inteligência artificial.</p>
